...
_C.TEST.SAVE_RESULTS_PATH = "ucf101.txt"
_C.TEST.CHECKPOINT_FOLDER = ''
# -----------------------------------------------------------------------------
# ResNet options
# -----------------------------------------------------------------------------
_C.RESNET = CfgNode()
...
#_C.TIMESFORMER.PRETRAINED_MODEL = '/mnt/newdisk/mnt/newdisk/weight/action/timesformer/TimeSformer_divST_8_224_SSv2.pyth'
# _C.TIMESFORMER.PRETRAINED_MODEL = '/mnt/newdisk/mnt/newdisk/weight/action/timesformer/times_ssv2v30_epoch8.pyth'
_C.TIMESFORMER.PRETRAINED_MODEL = '/root/autodl-tmp/weight/ucf101/1_14_ucf101_e8/checkpoint_epoch_00005.pyth'
# _C.TIMESFORMER.PRETRAINED_MODEL = '/mnt/newdisk/mnt/newdisk/result/action/timesformer/1_1_e8_k400/checkpoints/checkpoint_epoch_00008.pyth'
...
_C.DATA.PATH_PREFIX = ""
_C.DATA.Ucf101_PATH_TO_DATA_DIR = ""
_C.DATA.Ucf101_PATH_PREFIX = ""

_C.DATA.SSv2_PATH_TO_DATA_DIR = ""
_C.DATA.SSv2_PATH_PREFIX = ""

_C.DATA.Charades_PATH_TO_DATA_DIR = ""
_C.DATA.Charades_PATH_PREFIX = ""

_C.DATA.K400_PATH_TO_DATA_DIR = "/mnt/newdisk/mnt/newdisk/dataset/action/k400/label/timesformer/"

_C.DATA.K400_PATH_PREFIX = "/mnt/newdisk/mnt/newdisk/dataset/action/k400/video/v30/frame/train_256/"

_C.DATA.vb100_PATH_TO_DATA_DIR = ""
_C.DATA.vb100_PATH_PREFIX = ""

_C.DATA.ibc127_PATH_TO_DATA_DIR = ""
_C.DATA.ibc127_PATH_PREFIX = ""
...
_C.SOLVER.STEPS = [1,10,15]

# Learning rates for 'steps_' policies.
_C.SOLVER.LRS = [1,0.1,0.01]
