...
from data.multigrid_helper import ShortCycleBatchSampler
...
def construct_loader(cfg, split, dataset,is_precise_bn=False):
    """
    ...
    Args:
        ...
        split (str): the split of the data loader. Options include `train`,
            `val`, and `test`.
    """
    assert split in ["train", "val", "test","class"]
    if split in ["train"]:
